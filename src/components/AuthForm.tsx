...
export function AuthForm({ onClose }: AuthFormProps) {
  ...
  const userTypeOptions = [
    { value: "user", label: "Individual User", icon: "🚗", description: "Access mobility services and resources" },
    { value: "provider", label: "Service Provider", icon: "🔧", description: "Offering conversion services" },
    { value: "station_partner", label: "Station Partner", icon: "⛽", description: "Managing CNG/EV stations" },
  ];
      ...
      <div className="p-6 pb-4 border-b border-white/10 rounded-t-2xl flex-shrink-0">
        <div className="text-center">
          ...
          <p className="text-white/70">
            {isSignUp ? "Join Nigeria's clean mobility platform" : "Sign in to your account"}
          </p>
        </div>
      </div>
