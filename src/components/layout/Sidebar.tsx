...
const navigationConfig: Record<UserType, NavigationItem[]> = {
  user: [
    { id: 'dashboard', label: 'Dashboard', icon: '🏠', roles: ['user'], path: '/dashboard' },
    { id: 'checker', label: 'Vehicle Checker', icon: '🔍', roles: ['user'], path: '/vehicle-checker' },
    { id: 'providers', label: 'Find Providers', icon: '🔧', roles: ['user'], path: '/providers' },
    { id: 'stations', label: 'Station Map', icon: '🗺️', roles: ['user'], path: '/stations' },
    { id: 'booking', label: 'My Bookings', icon: '📅', roles: ['user'], path: '/bookings' },
    { id: 'learning', label: 'Learning Hub', icon: '📚', roles: ['user'], path: '/learning' },
    { id: 'trust-safety', label: 'Documents', icon: '🔒', roles: ['user'], path: '/documents' },
  ],
  provider: [
    { id: 'provider-dash', label: 'Dashboard', icon: '📊', roles: ['provider'], path: '/provider-dashboard' },
    { id: 'booking', label: 'Manage Bookings', icon: '📋', roles: ['provider'], path: '/manage-bookings' },
    { id: 'customers', label: 'Customers', icon: '👥', roles: ['provider'], path: '/customers' },
    { id: 'analytics', label: 'Analytics', icon: '📈', roles: ['provider'], path: '/analytics' },
    { id: 'trust-safety', label: 'Checklists', icon: '✅', roles: ['provider'], path: '/checklists' },
  ],
  admin: [
    { id: 'admin-dashboard', label: 'Admin Dashboard', icon: '👑', roles: ['admin'], path: '/admin-dashboard' },
    { id: 'providers', label: 'All Providers', icon: '🔧', roles: ['admin'], path: '/admin/providers' },
    { id: 'stations', label: 'All Stations', icon: '🗺️', roles: ['admin'], path: '/admin/stations' },
    { id: 'users', label: 'User Management', icon: '👥', roles: ['admin'], path: '/admin/users' },
    { id: 'analytics', label: 'Platform Analytics', icon: '📈', roles: ['admin'], path: '/admin/analytics' },
  ],
};
